<!-- # File xử lí => Xem chi tiết sản phẩm -->
<?php 
    // get_header();
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" min="1" max="10" name="qty[<?php echo $item['id'];?>]"
                            ...
                            <td>
                                <a href="<?php echo $item['url_delete_cart']; ?>" title="Xóa sản phẩm"
                                    class="del-product"><i class="fa-regular fa-trash-can"></i></a>
                                <!-- <span class="delete_product"><i class="fa-regular fa-trash-can"></i></span> -->
                            </td>
                        </tr>
                        <?php
                        }
