<div class="menu-select">
    <ul class="menu">
        ...
        <li class="menu-item">
            <a href="?mod=product&act=main&cat_id=1" class="cards" onclick="toggleActive(this)">Laptop</a>
        </li>
        <li class="menu-item">
            <a href="?mod=product&act=main&cat_id=" class="cards" onclick="toggleActive(this)">Điện thoại</a>
        </li>
        <li class="menu-item">
